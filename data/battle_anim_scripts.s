...
gBattleAnims_StatusConditions::
	...
	.4byte Status_Infestation               @ B_ANIM_STATUS_INFESTATION
	.4byte Status_Piercing               	@ B_ANIM_STATUS_PIERCING
	.4byte Status_Null               		@ B_ANIM_STATUS_NULL
	.4byte Status_Reckless               	@ B_ANIM_STATUS_RECKLESS
	.4byte Status_Flustered               	@ B_ANIM_STATUS_FLUSTERED
	.4byte Status_Shaken               		@ B_ANIM_STATUS_SHAKEN
	.4byte Status_Petrified               	@ B_ANIM_STATUS_PETRIFIED
	.4byte Status_Spooked               	@ B_ANIM_STATUS_SPOOKED
	.4byte Status_Flooded               	@ B_ANIM_STATUS_FLOODED
	.4byte Status_Rooted               		@ B_ANIM_STATUS_ROOTED
	.4byte Status_Fear               		@ B_ANIM_STATUS_FEAR
	.4byte Status_Blindness              	@ B_ANIM_STATUS_BLINDNESS
...
@ majesity aniani animation TODO anim add look here lol bro good one comment sneaky sneaky
Status_Burn: 
	loadspritegfx ANIM_TAG_SMALL_EMBER
	playsewithpan SE_M_FLAME_WHEEL, SOUND_PAN_TARGET
	call BurnFlame
...
Status_Infestation:
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_ATTACKER, 1, 0, 18, 2
	createvisualtask AnimTask_BlendColorCycle, 2, F_PAL_ATTACKER, 2, 2, 0, 12, RGB(19, 26, 6)
	@@@ this is the move string shot
	loadspritegfx ANIM_TAG_STRING
	loadspritegfx ANIM_TAG_WEB_THREAD
	monbg ANIM_DEF_PARTNER
	delay 0
...
Status_Flustered:
	...
	playsewithpan SE_M_PETAL_DANCE, SOUND_PAN_TARGET
	@ being shaken
	createvisualtask AnimTask_HorizontalShake, 3, ANIM_TARGET, 4, 5
	loopsewithpan SE_M_STRENGTH, SOUND_PAN_TARGET, 8, 10
	createsprite gFallingFeatherSpriteTemplate, ANIM_TARGET, 0, 0, -16, 64, 2, 104, 11304, 32, 1
	delay 6
	createsprite gFallingFeatherSpriteTemplate, ANIM_TARGET, 0, 0, -16, 32, 2, 104, 11304, 32, 1
...
Status_Shaken:
	@ magnitude is here
	createvisualtask AnimTask_HorizontalShake, 3, ANIM_TARGET, 8, 15
	@createvisualtask AnimTask_HorizontalShake, 5, MAX_BATTLERS_COUNT, 0, 50
	loopsewithpan SE_M_STRENGTH, SOUND_PAN_TARGET, 8, 10
	delay 4
	end
