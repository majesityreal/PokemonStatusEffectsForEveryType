const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_TAIL_WHIP] = // MAJESITY - interesting... defense down is not considered a secondary effect? Look into this for multi effect attacks
    {
