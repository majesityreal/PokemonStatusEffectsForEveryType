...
static const union AnimCmd sAnim_Toothless_1[] =
{
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_FRAME(1, 30), // MAJESITY - fix this to get animation
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_TOOTHLESS]   = sAnims_Toothless,
